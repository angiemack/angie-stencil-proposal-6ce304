...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-0.5 px-5 py-4 border-b pr-12", className)}
      {...props}
    />
  )
}
...
function SheetBody({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex-1 overflow-y-auto px-5 py-5 flex flex-col gap-5", className)}
      {...props}
    />
  )
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-2 px-5 py-4 border-t", className)}
      {...props}
    />
  )
}
